...
for i = 1:totalNumSamp
    ...
    % Print out raw intensities (some multiplied by 1000 for units -BHT)
    fprintf(fileID, '%0.12f\t%0.12f\t%0.12f\t%0.12f\t%0.12f\t%0.12f\t', ...
         out_samp_U238raw(i), out_samp_U236raw(i)*1000, out_samp_Th230raw(i), out_samp_Th229raw(i)*1000, out_samp_Th230bgraw(i), out_samp_U234tU234(i)*1000);
...
fprintf(fileID, ['Sample Name\t' ...
                 '238U\t2sigma\t232Th\t2sigma\td234U\t2sigma\t(230Th/238U)\t2sigma\t230Th/232Th\t2sigma\t'...
                 'Age (uncorr)\t2sigma\tAge (corr)\t2sigma\td234init\t2sigma\tAge (corr)\t2sigma\n']);
fprintf(fileID, ['\t' ...
...
for i = 1:totalNumSamp
    ...
    fprintf(fileID, ['%s\t' ...
         ...
         sample_name, out_conc(i, :), out_dates(i, 1:8));
end
